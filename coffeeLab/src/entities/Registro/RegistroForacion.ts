...
export class RegistroForacion{
    ...
    insertQuery(){
        return `INSERT INTO RegistroForacion (lote,fechaInicio,clasificacion,fechaFinal) 
            VALUES (${this.siembra.lote.codigo},'${this.fechaInicio}','${this.clasificacion}',${this.fechaFinal});`
    }
    ...
    static getSqlCreteTable(){
        return `CREATE TABLE IF NOT EXISTS RegistroForacion (
            ...
            fechaInicio text NOT NULL REFERENCES Siembra,
